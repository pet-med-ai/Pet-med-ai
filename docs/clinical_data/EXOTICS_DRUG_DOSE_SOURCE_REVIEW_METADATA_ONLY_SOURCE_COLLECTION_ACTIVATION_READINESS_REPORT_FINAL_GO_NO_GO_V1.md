...
This stage defines the final Go/No-Go shell after the metadata-only source collection activation readiness report.
...
The final Go/No-Go shell covers all supported exotics species groups and source review domains. It records only
metadata-only governance and readiness status fields. It is a safety gate, not a collection workspace and not an
execution step.

## Explicitly forbidden

This final Go/No-Go stage must not contain or enable:
