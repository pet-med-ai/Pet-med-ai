...
def main() -> int:
    ...
    need(commands[-3:] == ["python3 " + VALIDATOR + " || exit 1", fresh_target_authorization_review_command, fresh_target_external_execution_authorization_command], "CI command order")
