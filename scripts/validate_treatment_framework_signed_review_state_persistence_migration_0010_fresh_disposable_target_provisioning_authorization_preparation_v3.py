...
def main() -> int:
    ...
    need(commands[-5:-1] == ["python3 " + VALIDATOR + " || exit 1", fresh_target_authorization_review_command, fresh_target_external_execution_authorization_command, fresh_target_execution_evidence_command], "CI command order")
