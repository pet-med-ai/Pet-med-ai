...
# Restores cumulative smoke coverage by running current hard gates plus the
# embedded legacy cumulative smoke from 0c8fd5d:scripts/smoke_petmed.sh.
# Read-only: this script must not write database state or enable feature flags.
...
LEGACY_SMOKE_FILE="${TMP_DIR}/embedded_legacy_smoke_petmed_0c8fd5d.sh"
...
write_embedded_legacy_smoke() {
  cat > "${LEGACY_SMOKE_FILE}" <<'__PETMED_EMBEDDED_LEGACY_SMOKE_0C8FD5D_EOF__'
#!/usr/bin/env bash
set -euo pipefail
...
# --- Exotics Drug Dose Source Review Source Registry V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_source_registry.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Source Registry V1 validator"
  python3 scripts/validate_exotics_drug_dose_source_review_source_registry.py
fi
# --- Exotics Drug Dose Source Review Source Registry V1 smoke: end ---

# --- Exotics Drug Dose Source Review Source Collection Protocol V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_source_collection_protocol.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Source Collection Protocol V1 validator"
...
# --- Exotics Drug Dose Source Review Source Collection Execution Controlled Pilot V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_source_collection_execution_controlled_pilot.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Source Collection Execution Controlled Pilot V1 validator"
  python3 scripts/validate_exotics_drug_dose_source_review_source_collection_execution_controlled_pilot.py
fi
# --- Exotics Drug Dose Source Review Source Collection Execution Controlled Pilot V1 smoke: end ---

# --- Exotics Drug Dose Source Review Source Collection Controlled Pilot Report V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_source_collection_controlled_pilot_report.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Source Collection Controlled Pilot Report V1 validator"
...
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Validation Report V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_collection_workspace_validation_report.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Collection Workspace Validation Report V1 validator"
  python3 scripts/validate_exotics_drug_dose_source_review_metadata_only_collection_workspace_validation_report.py
fi
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Validation Report V1 smoke: end ---

# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_collection_workspace_governance_signoff.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff V1 validator"
  python3 scripts/validate_exotics_drug_dose_source_review_metadata_only_collection_workspace_governance_signoff.py
fi
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff V1 smoke: end ---

# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_collection_workspace_governance_signoff_record.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record V1 validator"
...
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record Validation V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_collection_workspace_governance_signoff_record_validation.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record Validation V1"
...
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record Validation V1 smoke: end ---

# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record Validation Report V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_collection_workspace_governance_signoff_record_validation_report.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record Validation Report V1 validator"
...
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_readiness.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness V1 validator"
  python3 scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_readiness.py
fi
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness V1 smoke: end ---

# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_readiness_report.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report V1 validator"
  python3 scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_readiness_report.py
fi
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report V1 smoke: end ---

# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report Final Go/No-Go V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_readiness_report_final_go_no_go.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report Final Go/No-Go V1 validator"
  python3 scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_readiness_report_final_go_no_go.py
fi
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report Final Go/No-Go V1 smoke: end ---
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_governance_signoff.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff V1 validator"
...
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff V1 smoke: end ---

# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_governance_signoff_record.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record V1 validator"
...
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record V1 smoke: end ---

# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Validation V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_governance_signoff_record_validation.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Validation V1 validator"
...
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Final Go/No-Go V1 smoke: start ---
if [ -f scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_governance_signoff_record_final_go_no_go.py ]; then
  echo "[smoke] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Final Go/No-Go V1 validator"
...
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Final Go/No-Go V1 smoke: end ---
__PETMED_EMBEDDED_LEGACY_SMOKE_0C8FD5D_EOF__
  chmod +x "${LEGACY_SMOKE_FILE}"

  legacy_lines="$(wc -l < "${LEGACY_SMOKE_FILE}" | tr -d ' ')"
  if [ "$legacy_lines" -lt "$MIN_LEGACY_SMOKE_LINES" ]; then
    echo "NO-GO: embedded legacy cumulative smoke is too small: ${legacy_lines} < ${MIN_LEGACY_SMOKE_LINES}" >&2
    exit 1
  fi
  if grep -q 'CI_SMOKE_CUMULATIVE_GUARD_RESTORE_V1' "${LEGACY_SMOKE_FILE}"; then
    echo "NO-GO: embedded legacy smoke unexpectedly points to the restore wrapper, not the baseline cumulative smoke" >&2
    exit 1
  fi
  printf '%s\n' "[smoke_petmed] embedded legacy cumulative smoke lines: ${legacy_lines}"
}
...
check_confirmed_diagnosis_treatment_framework_draft_v1() {
  local endpoint="${BASE_URL}/api/diagnostic-data/dry-run/confirmed-diagnosis/treatment-framework/build"
  local status_file="${TMP_DIR}/confirmed_diagnosis_treatment_framework_status.txt"
  local body_file="${TMP_DIR}/confirmed_diagnosis_treatment_framework_body.json"
  local payload_file="${TMP_DIR}/confirmed_diagnosis_treatment_framework_payload.json"

  printf '%s\n' "[smoke_petmed] confirmed diagnosis treatment framework dry-run endpoint: ${endpoint}"
...
PY_SET_CASE_ID
    ...
    if [ "${http_status}" != "200" ]; then
      echo "NO-GO: treatment framework authenticated smoke expected HTTP 200, got ${http_status}" >&2
      cat "${body_file}" >&2 || true
      exit 1
    fi
    python3 - "${body_file}" <<'PY_TREATMENT_FRAMEWORK_RESPONSE_CHECK'
import json
import re
import sys
path = sys.argv[1]
with open(path, "r", encoding="utf-8") as handle:
    data = json.load(handle)
errors = []
if data.get("message") != "confirmed_diagnosis_treatment_framework_built":
    errors.append("message mismatch")
if data.get("mode") != "confirmed_diagnosis_treatment_framework_draft_v1":
...
for pattern in [r"\b\d+(?:\.\d+)?\s*(?:mg|mcg|ug|g|ml|mL|iu|IU)\s*/\s*kg\b", r"\bq\s*\d+\s*h\b", r"\b(?:SID|BID|TID|QID|q12h|q24h|q8h|q6h|q4h|PO|IV|IM|SC|SQ)\b", r"\b(?:prescribe|prescription|dispense|administer)\b"]:
    if re.search(pattern, text, re.IGNORECASE):
        errors.append("forbidden preview wording matched: " + pattern)
if errors:
    print("NO-GO: treatment framework response failed")
    for error in errors:
        print(error)
    sys.exit(1)
print("PASS: treatment framework authenticated dry-run response")
PY_TREATMENT_FRAMEWORK_RESPONSE_CHECK
    printf '%s\n' "treatment_framework_dry_run_endpoint_smoke=PASS"
    printf '%s\n' "treatment_framework_authenticated_payload_smoke=PASS"
    printf '%s\n' "writes_database=false"
    return 0
  fi
  ...
  case "${http_status}" in
    401|403)
      printf '%s\n' "PASS: treatment framework dry-run endpoint registered and protected"
      printf '%s\n' "treatment_framework_dry_run_endpoint_smoke=PASS"
      printf '%s\n' "endpoint_requires_authentication=true"
      printf '%s\n' "authenticated_payload_smoke=SKIPPED_AUTH_TOKEN_AND_SMOKE_CASE_ID_NOT_SET"
      ;;
    422)
      printf '%s\n' "PASS: treatment framework dry-run endpoint registered and validation-gated"
      printf '%s\n' "treatment_framework_dry_run_endpoint_smoke=PASS"
      printf '%s\n' "endpoint_validation_gate_reached=true"
      printf '%s\n' "authenticated_payload_smoke=SKIPPED_AUTH_TOKEN_AND_SMOKE_CASE_ID_NOT_SET"
      ;;
    404)
      echo "NO-GO: treatment framework dry-run endpoint returned 404" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
    000)
      echo "NO-GO: treatment framework dry-run endpoint curl failed" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
    *)
      echo "NO-GO: unexpected treatment framework endpoint HTTP status ${http_status}" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
  esac
...
# --- Treatment Framework Clinician Review Workflow V1 smoke: start ---
check_treatment_framework_clinician_review_workflow_v1() {
  local endpoint="${BASE_URL}/api/diagnostic-data/dry-run/confirmed-diagnosis/treatment-framework/review"
  local status_file="${TMP_DIR}/treatment_framework_clinician_review_workflow_status.txt"
  local body_file="${TMP_DIR}/treatment_framework_clinician_review_workflow_body.json"
  local payload_file="${TMP_DIR}/treatment_framework_clinician_review_workflow_payload.json"

  printf '%s\n' "[smoke_petmed] treatment framework clinician review workflow dry-run endpoint: ${endpoint}"
...
PY_SET_CASE_ID
    ...
    printf '%s\n' "${http_status}" > "${status_file}"
    if [ "${http_status}" != "200" ]; then
      echo "NO-GO: treatment framework review workflow authenticated smoke expected HTTP 200, got ${http_status}" >&2
      cat "${body_file}" >&2 || true
      exit 1
    fi
    python3 - "${body_file}" <<'PY_REVIEW_WORKFLOW_RESPONSE_CHECK'
import json
import re
import sys
path = sys.argv[1]
with open(path, "r", encoding="utf-8") as handle:
    data = json.load(handle)
errors = []
if data.get("message") != "treatment_framework_clinician_review_workflow_built":
    errors.append("message mismatch")
if data.get("mode") != "treatment_framework_clinician_review_workflow_v1":
    errors.append("mode mismatch")
quality_gate = data.get("quality_gate") or {}
safety = data.get("safety") or {}
workflow = data.get("review_workflow") or {}
expected_true = [
    (quality_gate, "requires_confirmed_diagnosis"),
    (quality_gate, "requires_clinician_confirmed_diagnosis"),
    (quality_gate, "ai_does_not_confirm_diagnosis"),
    (quality_gate, "review_decision_allowed"),
    (quality_gate, "review_decision_preview_only"),
    (quality_gate, "blocks_prescription"),
    (quality_gate, "blocks_dose"),
    (quality_gate, "blocks_route_frequency"),
    (safety, "read_only"),
    (safety, "dry_run"),
    (safety, "review_decision_preview_only"),
    (safety, "not_client_facing"),
    (safety, "requires_human_review"),
    (safety, "clinician_signoff_required"),
    (workflow, "dry_run"),
    (workflow, "review_decision_preview_only"),
]
for container, key in expected_true:
    if container.get(key) is not True:
        errors.append(f"{key} expected true")
expected_false = [
    ...
    (safety, "persists_review_state"),
    (safety, "external_ai_provider_call"),
    (workflow, "final_signoff_persisted"),
    (workflow, "review_status_persisted"),
    (workflow, "client_release_allowed"),
    (workflow, "persistence_allowed"),
]
for container, key in expected_false:
    if container.get(key) is not False:
        errors.append(f"{key} expected false")
...
for pattern in [r"\b\d+(?:\.\d+)?\s*(?:mg|mcg|ug|g|ml|mL|iu|IU)\s*/\s*kg\b", r"\bq\s*\d+\s*h\b", r"\b(?:SID|BID|TID|QID|q12h|q24h|q8h|q6h|q4h|PO|IV|IM|SC|SQ)\b", r"\b(?:prescribe|prescription|dispense|administer)\b"]:
    if re.search(pattern, text, re.IGNORECASE):
        errors.append("forbidden preview wording matched: " + pattern)
if errors:
    print("NO-GO: treatment framework clinician review workflow response failed")
    for error in errors:
        print(error)
    sys.exit(1)
print("PASS: treatment framework clinician review workflow authenticated dry-run response")
PY_REVIEW_WORKFLOW_RESPONSE_CHECK
    printf '%s\n' "treatment_framework_clinician_review_workflow_smoke=PASS"
    printf '%s\n' "treatment_framework_clinician_review_workflow_authenticated_payload_smoke=PASS"
    printf '%s\n' "writes_database=false"
    return 0
  fi
  ...
  case "${http_status}" in
    401|403)
      printf '%s\n' "PASS: treatment framework clinician review workflow endpoint registered and protected"
      printf '%s\n' "treatment_framework_clinician_review_workflow_smoke=PASS"
      printf '%s\n' "review_workflow_endpoint_requires_authentication=true"
      printf '%s\n' "review_workflow_authenticated_payload_smoke=SKIPPED_AUTH_TOKEN_AND_SMOKE_CASE_ID_NOT_SET"
      ;;
    422)
      printf '%s\n' "PASS: treatment framework clinician review workflow endpoint registered and validation-gated"
      printf '%s\n' "treatment_framework_clinician_review_workflow_smoke=PASS"
      printf '%s\n' "review_workflow_endpoint_validation_gate_reached=true"
      printf '%s\n' "review_workflow_authenticated_payload_smoke=SKIPPED_AUTH_TOKEN_AND_SMOKE_CASE_ID_NOT_SET"
      ;;
    404)
      echo "NO-GO: treatment framework clinician review workflow endpoint returned 404" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
    000)
      echo "NO-GO: treatment framework clinician review workflow endpoint curl failed" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
    *)
      echo "NO-GO: unexpected treatment framework clinician review workflow endpoint HTTP status ${http_status}" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
  esac
...
# --- Case Detail Treatment Framework Signed Review State UI V1 smoke: start ---
check_case_detail_treatment_framework_signed_review_state_ui_v1() {
  printf '%s
' "[smoke_petmed] case detail treatment framework signed review state UI static check"

  grep -q 'Case Detail Treatment Framework Signed Review State UI V1' frontend/src/pages/CaseDetail.jsx
  grep -q '/api/diagnostic-data/dry-run/confirmed-diagnosis/treatment-framework/signed-review-state/build' frontend/src/pages/CaseDetail.jsx
  grep -q 'TreatmentFrameworkSignedReviewStatePanel' frontend/src/pages/CaseDetail.jsx
  grep -q 'buildTreatmentFrameworkSignedReviewStatePreview' frontend/src/pages/CaseDetail.jsx
  grep -q 'buildSignedReviewStateAuditReference' frontend/src/pages/CaseDetail.jsx
  grep -q 'confirmation_source: "clinician"' frontend/src/pages/CaseDetail.jsx
  grep -q 'ai_generated: false' frontend/src/pages/CaseDetail.jsx
  grep -q 'signed_review_state_dry_run_only=true' frontend/src/pages/CaseDetail.jsx
  ...
  printf '%s
' "PASS: case detail treatment framework signed review state UI static markers"
  printf '%s
...
# --- Case Detail Treatment Framework Signed Review State UI V1 smoke: end ---

# --- Treatment Framework Signed Review State Persistence Design V1 smoke: start ---
check_treatment_framework_signed_review_state_persistence_design_v1() {
  printf '%s\n' "[smoke_petmed] treatment framework signed review state persistence design static check"
  ...
  grep -q 'persistence_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DESIGN_V1.md
  ...
  grep -q 'signed_review_state_persistence_dry_run_required_first=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DESIGN_V1.md
  grep -q 'migration_readiness_required=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DESIGN_V1.md
  grep -q 'no_business_logic_change=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DESIGN_V1.md
  grep -q 'no_backend_endpoint_change=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DESIGN_V1.md
  grep -q 'no_frontend_ui_change=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DESIGN_V1.md
  grep -q 'no_migration=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DESIGN_V1.md
  grep -q 'no_case_treatment_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DESIGN_V1.md
  grep -q 'no_case_treatment_persistence=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DESIGN_V1.md
  grep -q 'no_prescription_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DESIGN_V1.md
  grep -q 'no_dose_route_frequency=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DESIGN_V1.md
  ...
  grep -q 'validate_treatment_framework_signed_review_state_persistence_design.py' scripts/ci_static_checks.sh

  printf '%s\n' "PASS: treatment framework signed review state persistence design static markers"
...
# --- Treatment Framework Signed Review State Persistence Design V1 smoke: end ---

# --- Treatment Framework Signed Review State Persistence Dry Run V1 smoke: start ---
check_treatment_framework_signed_review_state_persistence_dry_run_v1() {
  local endpoint="${BASE_URL}/api/diagnostic-data/dry-run/confirmed-diagnosis/treatment-framework/signed-review-state/persistence/prepare"
  local status_file="${TMP_DIR}/treatment_framework_signed_review_state_persistence_status.txt"
  local body_file="${TMP_DIR}/treatment_framework_signed_review_state_persistence_body.json"
  local payload_file="${TMP_DIR}/treatment_framework_signed_review_state_persistence_payload.json"

  printf '%s\n' "[smoke_petmed] treatment framework signed review state persistence dry-run endpoint: ${endpoint}"
  ...
  cat > "${payload_file}" <<'JSON_PAYLOAD'
{
  ...
  "signed_review_state_preview": {
    "state_preview_id": "signed-review-state-preview-1",
    "case_id": 1,
    "review_decision": "approve_for_clinician_use",
  ...
  "persistence_requested_by": "smoke-test-signer"
}
JSON_PAYLOAD
...
with open(path, "r", encoding="utf-8") as handle:
    payload = json.load(handle)
payload["case_id"] = int(case_id)
payload["signed_review_state_preview"]["case_id"] = int(case_id)
with open(path, "w", encoding="utf-8") as handle:
    json.dump(payload, handle, ensure_ascii=False)
PY_SET_CASE_ID
    http_status="$(curl -sS -o "${body_file}" -w '%{http_code}' \
    ...
    printf '%s\n' "${http_status}" > "${status_file}"
    if [ "${http_status}" != "200" ]; then
      echo "NO-GO: treatment framework signed review state persistence dry-run authenticated smoke expected HTTP 200, got ${http_status}" >&2
      cat "${body_file}" >&2 || true
      exit 1
    fi
    python3 - "${body_file}" <<'PY_PERSISTENCE_DRY_RUN_RESPONSE_CHECK'
import json
import re
import sys
path = sys.argv[1]
with open(path, "r", encoding="utf-8") as handle:
    data = json.load(handle)
errors = []
if data.get("message") != "treatment_framework_signed_review_state_persistence_dry_run_built":
    errors.append("message mismatch")
if data.get("mode") != "treatment_framework_signed_review_state_persistence_dry_run_v1":
    errors.append("mode mismatch")
quality_gate = data.get("quality_gate") or {}
safety = data.get("safety") or {}
preview = data.get("persistence_dry_run_preview") or {}
expected_true = [
    (quality_gate, "requires_confirmed_diagnosis"),
    (quality_gate, "requires_clinician_confirmed_diagnosis"),
    (quality_gate, "ai_does_not_confirm_diagnosis"),
    (quality_gate, "audit_log_reference_present"),
    (quality_gate, "signed_review_state_preview_present"),
    (quality_gate, "signed_review_state_persistence_preview_only"),
    (quality_gate, "blocks_prescription"),
    (quality_gate, "blocks_dose"),
    (quality_gate, "blocks_route_frequency"),
    (quality_gate, "migration_readiness_required"),
    (safety, "read_only"),
    (safety, "dry_run"),
    (safety, "signed_review_state_persistence_preview_only"),
    (safety, "migration_readiness_required"),
    (safety, "not_client_facing"),
    (safety, "requires_human_review"),
    (safety, "clinician_signoff_required"),
    (preview, "dry_run"),
    (preview, "audit_log_reference_present"),
    (preview, "migration_readiness_required"),
    (preview, "signed_review_state_persistence_requires_future_go_no_go"),
]
for container, key in expected_true:
    if container.get(key) is not True:
        errors.append(f"{key} expected true")
expected_false = [
    ...
    (quality_gate, "writes_case_treatment"),
    (quality_gate, "persists_treatment_framework"),
    (quality_gate, "persists_signed_review_state"),
    (quality_gate, "signed_review_state_persistence_enabled"),
    (quality_gate, "review_state_persistence_enabled"),
    (safety, "writes_database"),
    (safety, "writes_case_treatment"),
    (safety, "persists_treatment_framework"),
    ...
    (safety, "creates_signed_review_state"),
    (safety, "persists_signed_review_state"),
    (safety, "signed_review_state_persistence_enabled"),
    (safety, "review_state_persistence_enabled"),
    (preview, "persisted"),
    (preview, "writes_database"),
    (preview, "signed_review_state_persistence_enabled"),
    (preview, "review_state_persistence_enabled"),
    (preview, "will_write_now"),
]
for container, key in expected_false:
    if container.get(key) is not False:
        errors.append(f"{key} expected false")
text = json.dumps(data.get("treatment_framework_preview") or {}, ensure_ascii=False)
text += json.dumps(data.get("signed_review_state_preview") or {}, ensure_ascii=False)
for pattern in [r"\b\d+(?:\.\d+)?\s*(?:mg|mcg|ug|g|ml|mL|iu|IU)\s*/\s*kg\b", r"\bq\s*\d+\s*h\b", r"\b(?:SID|BID|TID|QID|q12h|q24h|q8h|q6h|PO|IV|IM|SC|SQ)\b", r"\b(?:prescribe|prescription|dispense|administer)\b"]:
    if re.search(pattern, text, re.IGNORECASE):
        errors.append("forbidden persistence dry-run wording matched: " + pattern)
if errors:
    print("NO-GO: treatment framework signed review state persistence dry-run response failed")
    for error in errors:
        print(error)
    sys.exit(1)
print("PASS: treatment framework signed review state persistence dry-run authenticated response")
PY_PERSISTENCE_DRY_RUN_RESPONSE_CHECK
    printf '%s\n' "treatment_framework_signed_review_state_persistence_dry_run_smoke=PASS"
    printf '%s\n' "treatment_framework_signed_review_state_persistence_authenticated_payload_smoke=PASS"
    printf '%s\n' "writes_database=false"
    return 0
  fi
  ...
  case "${http_status}" in
    401|403)
      printf '%s\n' "PASS: treatment framework signed review state persistence dry-run endpoint registered and protected"
      printf '%s\n' "treatment_framework_signed_review_state_persistence_dry_run_smoke=PASS"
      printf '%s\n' "signed_review_state_persistence_endpoint_requires_authentication=true"
      printf '%s\n' "signed_review_state_persistence_authenticated_payload_smoke=SKIPPED_AUTH_TOKEN_AND_SMOKE_CASE_ID_NOT_SET"
      ;;
    422)
      printf '%s\n' "PASS: treatment framework signed review state persistence dry-run endpoint registered and validation-gated"
      printf '%s\n' "treatment_framework_signed_review_state_persistence_dry_run_smoke=PASS"
      printf '%s\n' "signed_review_state_persistence_endpoint_validation_gate_reached=true"
      printf '%s\n' "signed_review_state_persistence_authenticated_payload_smoke=SKIPPED_AUTH_TOKEN_AND_SMOKE_CASE_ID_NOT_SET"
      ;;
    404)
      echo "NO-GO: treatment framework signed review state persistence dry-run endpoint returned 404" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
    000)
      echo "NO-GO: treatment framework signed review state persistence dry-run endpoint curl failed" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
    *)
      echo "NO-GO: unexpected treatment framework signed review state persistence dry-run endpoint HTTP status ${http_status}" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
  esac
...
check_treatment_framework_signed_review_state_persistence_risk_review_v1() {
  printf '%s\n' "[smoke_petmed] treatment framework signed review state persistence risk review static check"
  ...
  grep -q 'persistence_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_RISK_REVIEW_V1.md
  ...
  grep -q 'signed_review_state_persistence_design_required=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_RISK_REVIEW_V1.md
  grep -q 'signed_review_state_persistence_dry_run_required_before_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_RISK_REVIEW_V1.md
  grep -q 'migration_readiness_required=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_RISK_REVIEW_V1.md
  grep -q 'no_business_logic_change=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_RISK_REVIEW_V1.md
  grep -q 'no_backend_endpoint_change=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_RISK_REVIEW_V1.md
  grep -q 'no_frontend_ui_change=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_RISK_REVIEW_V1.md
  grep -q 'no_migration=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_RISK_REVIEW_V1.md
  ...
  grep -q 'no_case_treatment_persistence=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_RISK_REVIEW_V1.md
  grep -q 'no_prescription_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_RISK_REVIEW_V1.md
  grep -q 'no_dose_route_frequency=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_RISK_REVIEW_V1.md
  ...
  grep -q 'validate_treatment_framework_signed_review_state_persistence_risk_review.py' scripts/ci_static_checks.sh

  printf '%s\n' "PASS: treatment framework signed review state persistence risk review static markers"
...
# --- Treatment Framework Signed Review State Persistence Risk Review V1 smoke: end ---

# --- Treatment Framework Signed Review State Persistence Migration Readiness Review V1 smoke: start ---
check_treatment_framework_signed_review_state_persistence_migration_readiness_review_v1() {
  printf '%s\n' "[smoke_petmed] treatment framework signed review state persistence migration readiness review static check"
  ...
  grep -q 'persistence_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_READINESS_REVIEW_V1.md
  ...
  grep -q 'review_state_persistence_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_READINESS_REVIEW_V1.md
  grep -q 'writes_database=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_READINESS_REVIEW_V1.md
  grep -q 'no_case_treatment_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_READINESS_REVIEW_V1.md
  grep -q 'no_case_treatment_persistence=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_READINESS_REVIEW_V1.md
  grep -q 'no_prescription_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_READINESS_REVIEW_V1.md
  grep -q 'no_dose_route_frequency=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_READINESS_REVIEW_V1.md
  ...
  grep -q 'authenticated_smoke_required_before_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_READINESS_REVIEW_V1.md
  ...
  grep -q 'validate_treatment_framework_signed_review_state_persistence_migration_readiness_review.py' scripts/ci_static_checks.sh

  printf '%s\n' "PASS: treatment framework signed review state persistence migration readiness review static markers"
...
# --- Treatment Framework Signed Review State Persistence Migration Readiness Review V1 smoke: end ---

# --- Treatment Framework Signed Review State Persistence Migration Design V1 smoke: start ---
check_treatment_framework_signed_review_state_persistence_migration_design_v1() {
  printf '%s\n' "[smoke_petmed] treatment framework signed review state persistence migration design static check"

  grep -q 'TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'migration_design_only=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'migration_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'migration_file_created=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'schema_change_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'persistence_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'signed_review_state_persistence_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'review_state_persistence_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'migration_dry_run_required_first=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'migration_readiness_review_completed=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'migration_model_design_only=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'no_backend_endpoint_change=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'no_frontend_ui_change=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'no_migration=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'writes_database=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'no_case_treatment_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'no_case_treatment_persistence=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'no_prescription_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'no_dose_route_frequency=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'rollback_plan_required=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'backup_restore_evidence_required=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'authenticated_smoke_required_before_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'append_only_audit_linkage_required=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'NO_GO_TO_SIGNED_REVIEW_STATE_DATABASE_WRITE' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_GO_NO_GO_V1.csv
  grep -q 'GO_TO_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DRY_RUN_V1' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DESIGN_V1.md
  grep -q 'validate_treatment_framework_signed_review_state_persistence_migration_design.py' scripts/ci_static_checks.sh

  printf '%s\n' "PASS: treatment framework signed review state persistence migration design static markers"
...
# --- Treatment Framework Signed Review State Persistence Migration Design V1 smoke: end ---

# --- Treatment Framework Signed Review State Persistence Migration Dry Run V1 smoke: start ---
check_treatment_framework_signed_review_state_persistence_migration_dry_run_v1() {
  local endpoint="${BASE_URL}/api/diagnostic-data/dry-run/confirmed-diagnosis/treatment-framework/signed-review-state/persistence/migration/dry-run"
  local status_file="${TMP_DIR}/treatment_framework_signed_review_state_persistence_migration_dry_run_status.txt"
  local body_file="${TMP_DIR}/treatment_framework_signed_review_state_persistence_migration_dry_run_body.json"
  local payload_file="${TMP_DIR}/treatment_framework_signed_review_state_persistence_migration_dry_run_payload.json"

  printf '%s\n' "[smoke_petmed] treatment framework signed review state persistence migration dry-run endpoint: ${endpoint}"
  ...
  cat > "${payload_file}" <<'JSON_PAYLOAD'
{
  ...
  "persistence_dry_run_preview": {
    "preview_id": "signed-review-state-persistence-dry-run-1",
    "case_id": 1,
  ...
  "migration_readiness_review_completed": true,
  "migration_dry_run_requested_by": "smoke-test-signer"
}
JSON_PAYLOAD
...
payload["case_id"] = int(case_id)
payload["signed_review_state_preview"]["case_id"] = int(case_id)
payload["persistence_dry_run_preview"]["case_id"] = int(case_id)
with open(path, "w", encoding="utf-8") as handle:
    json.dump(payload, handle, ensure_ascii=False)
PY_SET_CASE_ID
    http_status="$(curl -sS -o "${body_file}" -w '%{http_code}' \
    ...
    printf '%s\n' "${http_status}" > "${status_file}"
    if [ "${http_status}" != "200" ]; then
      echo "NO-GO: treatment framework signed review state persistence migration dry-run authenticated smoke expected HTTP 200, got ${http_status}" >&2
      cat "${body_file}" >&2 || true
      exit 1
    fi
    python3 - "${body_file}" <<'PY_MIGRATION_DRY_RUN_RESPONSE_CHECK'
import json
import re
import sys
path = sys.argv[1]
with open(path, "r", encoding="utf-8") as handle:
    data = json.load(handle)
errors = []
if data.get("message") != "treatment_framework_signed_review_state_persistence_migration_dry_run_built":
    errors.append("message mismatch")
if data.get("mode") != "treatment_framework_signed_review_state_persistence_migration_dry_run_v1":
    errors.append("mode mismatch")
quality_gate = data.get("quality_gate") or {}
safety = data.get("safety") or {}
preview = data.get("migration_plan_preview") or {}
expected_true = [
    (quality_gate, "requires_confirmed_diagnosis"),
    (quality_gate, "requires_clinician_confirmed_diagnosis"),
    (quality_gate, "ai_does_not_confirm_diagnosis"),
    (quality_gate, "signed_review_state_preview_present"),
    (quality_gate, "persistence_dry_run_preview_present"),
    (quality_gate, "migration_design_acknowledged"),
    (quality_gate, "migration_readiness_review_completed"),
    (quality_gate, "migration_dry_run_only"),
    (quality_gate, "blocks_prescription"),
    (quality_gate, "blocks_dose"),
    (quality_gate, "blocks_route_frequency"),
    (quality_gate, "migration_readiness_required"),
    (quality_gate, "rollback_plan_required"),
    (quality_gate, "backup_restore_evidence_required"),
    (quality_gate, "authenticated_smoke_required_before_write"),
    (safety, "read_only"),
    (safety, "dry_run"),
    (safety, "migration_dry_run_only"),
    (safety, "migration_readiness_required"),
    (safety, "rollback_plan_required"),
    (safety, "backup_restore_evidence_required"),
    (safety, "authenticated_smoke_required_before_write"),
    (safety, "not_client_facing"),
    (safety, "requires_human_review"),
    (safety, "clinician_signoff_required"),
    (preview, "dry_run"),
    (preview, "migration_dry_run_only"),
    (preview, "migration_design_acknowledged"),
    (preview, "migration_readiness_review_completed"),
    (preview, "migration_readiness_required"),
    (preview, "requires_future_go_no_go"),
]
for container, key in expected_true:
    if container.get(key) is not True:
        errors.append(f"{key} expected true")
expected_false = [
    (quality_gate, "migration_enabled"),
    (quality_gate, "migration_file_created"),
    (quality_gate, "schema_change_enabled"),
    (quality_gate, "writes_database"),
    (quality_gate, "writes_case_treatment"),
    (quality_gate, "persists_treatment_framework"),
    (quality_gate, "persists_signed_review_state"),
    (quality_gate, "signed_review_state_persistence_enabled"),
    (quality_gate, "review_state_persistence_enabled"),
    (safety, "migration_enabled"),
    (safety, "migration_file_created"),
    (safety, "schema_change_enabled"),
    (safety, "writes_database"),
    (safety, "writes_case_treatment"),
    (safety, "persists_treatment_framework"),
    (safety, "creates_prescription"),
    ...
    (safety, "signed_review_state_persistence_enabled"),
    (safety, "review_state_persistence_enabled"),
    (preview, "migration_enabled"),
    (preview, "migration_file_created"),
    (preview, "schema_change_enabled"),
    (preview, "will_apply_migration"),
    (preview, "writes_database"),
    (preview, "signed_review_state_persistence_enabled"),
    (preview, "review_state_persistence_enabled"),
]
...
for pattern in [r"\b\d+(?:\.\d+)?\s*(?:mg|mcg|ug|g|ml|mL|iu|IU)\s*/\s*kg\b", r"\bq\s*\d+\s*h\b", r"\b(?:SID|BID|TID|QID|q12h|q24h|q8h|q6h|PO|IV|IM|SC|SQ)\b", r"\b(?:prescribe|prescription|dispense|administer)\b"]:
    if re.search(pattern, text, re.IGNORECASE):
        errors.append("forbidden migration dry-run wording matched: " + pattern)
if errors:
    print("NO-GO: treatment framework signed review state persistence migration dry-run response failed")
    for error in errors:
        print(error)
    sys.exit(1)
print("PASS: treatment framework signed review state persistence migration dry-run authenticated response")
PY_MIGRATION_DRY_RUN_RESPONSE_CHECK
    printf '%s\n' "treatment_framework_signed_review_state_persistence_migration_dry_run_smoke=PASS"
    printf '%s\n' "treatment_framework_signed_review_state_persistence_migration_authenticated_payload_smoke=PASS"
    printf '%s\n' "writes_database=false"
    return 0
  fi
  ...
  case "${http_status}" in
    401|403)
      printf '%s\n' "PASS: treatment framework signed review state persistence migration dry-run endpoint registered and protected"
      printf '%s\n' "treatment_framework_signed_review_state_persistence_migration_dry_run_smoke=PASS"
      printf '%s\n' "signed_review_state_persistence_migration_endpoint_requires_authentication=true"
      printf '%s\n' "signed_review_state_persistence_migration_authenticated_payload_smoke=SKIPPED_AUTH_TOKEN_AND_SMOKE_CASE_ID_NOT_SET"
      ;;
    422)
      printf '%s\n' "PASS: treatment framework signed review state persistence migration dry-run endpoint registered and validation-gated"
      printf '%s\n' "treatment_framework_signed_review_state_persistence_migration_dry_run_smoke=PASS"
      printf '%s\n' "signed_review_state_persistence_migration_endpoint_validation_gate_reached=true"
      printf '%s\n' "signed_review_state_persistence_migration_authenticated_payload_smoke=SKIPPED_AUTH_TOKEN_AND_SMOKE_CASE_ID_NOT_SET"
      ;;
    404)
      echo "NO-GO: treatment framework signed review state persistence migration dry-run endpoint returned 404" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
    000)
      echo "NO-GO: treatment framework signed review state persistence migration dry-run endpoint curl failed" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
    *)
      echo "NO-GO: unexpected treatment framework signed review state persistence migration dry-run endpoint HTTP status ${http_status}" >&2
      cat "${body_file}" >&2 || true
      exit 1
      ;;
  esac
}
# --- Treatment Framework Signed Review State Persistence Migration Dry Run V1 smoke: end ---


# --- Case Detail Treatment Framework Signed Review State Persistence Migration UI V1 smoke: start ---
check_case_detail_treatment_framework_signed_review_state_persistence_migration_ui_v1() {
  printf '%s\n' "[smoke_petmed] case detail treatment framework signed review state persistence migration UI static check"

  grep -q 'Case Detail Treatment Framework Signed Review State Persistence Migration UI V1' frontend/src/pages/CaseDetail.jsx
  grep -q '/api/diagnostic-data/dry-run/confirmed-diagnosis/treatment-framework/signed-review-state/persistence/migration/dry-run' frontend/src/pages/CaseDetail.jsx
  grep -q 'TreatmentFrameworkSignedReviewStateMigrationPanel' frontend/src/pages/CaseDetail.jsx
  grep -q 'buildTreatmentFrameworkSignedReviewStateMigrationPreview' frontend/src/pages/CaseDetail.jsx
  grep -q 'buildSignedReviewStateMigrationPayload' frontend/src/pages/CaseDetail.jsx
  grep -q 'confirmation_source: "clinician"' frontend/src/pages/CaseDetail.jsx
  grep -q 'ai_generated: false' frontend/src/pages/CaseDetail.jsx
  grep -q 'migration_dry_run_only=true' frontend/src/pages/CaseDetail.jsx
  grep -q 'migration_enabled=false' frontend/src/pages/CaseDetail.jsx
  grep -q 'migration_file_created=false' frontend/src/pages/CaseDetail.jsx
  grep -q 'schema_change_enabled=false' frontend/src/pages/CaseDetail.jsx
  grep -q 'persistence_enabled=false' frontend/src/pages/CaseDetail.jsx
  grep -q 'signed_review_state_persistence_enabled=false' frontend/src/pages/CaseDetail.jsx
  grep -q 'review_state_persistence_enabled=false' frontend/src/pages/CaseDetail.jsx
  grep -q 'writes_database=false' frontend/src/pages/CaseDetail.jsx
  ...
  printf '%s\n' "PASS: case detail treatment framework signed review state persistence migration UI static markers"
...
# --- Case Detail Treatment Framework Signed Review State Persistence Migration UI V1 smoke: end ---

# --- Treatment Framework Signed Review State Persistence Migration Final Go/No-Go V1 smoke: start ---
check_treatment_framework_signed_review_state_persistence_migration_final_go_no_go_v1() {
  printf '%s\n' "[smoke_petmed] treatment framework signed review state persistence migration final go/no-go static check"

  grep -q 'TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'final_go_no_go_only=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'migration_implementation_allowed=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'migration_apply_allowed=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'migration_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'migration_file_created=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'schema_change_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'persistence_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'signed_review_state_persistence_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'review_state_persistence_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'writes_database=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'no_case_treatment_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'no_case_treatment_persistence=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'no_prescription_write=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'no_dose_route_frequency=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'NO_GO_TO_DATABASE_WRITE' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'NO_GO_TO_CASE_TREATMENT_PERSISTENCE' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'GO_TO_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_IMPLEMENTATION_V1' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1.md
  grep -q 'GO_TO_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_IMPLEMENTATION_V1' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_DECISION_RECORD_V1.csv
  grep -q 'validate_treatment_framework_signed_review_state_persistence_migration_final_go_no_go.py' scripts/ci_static_checks.sh

  printf '%s\n' "PASS: treatment framework signed review state persistence migration final go/no-go static markers"
...
# --- Treatment Framework Signed Review State Persistence Migration Apply Readiness Review V1 smoke: start ---
check_treatment_framework_signed_review_state_persistence_migration_apply_readiness_review_v1() {
  printf '%s\n' "[smoke_petmed] treatment framework signed review state persistence migration apply readiness review static check"

  grep -q 'TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1.md
  grep -q 'apply_readiness_review_only=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1.md
  grep -q 'production_migration_apply_allowed=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1.md
  grep -q 'active_migration_file_created=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1.md
  grep -q 'migration_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1.md
  grep -q 'schema_change_enabled=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1.md
  grep -q 'writes_database=false' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1.md
  grep -q 'staging_rehearsal_required=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1.md
  grep -q 'rollback_dry_run_required=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1.md
  grep -q 'backup_restore_evidence_required=true' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1.md
  grep -q 'NO_GO_TO_PRODUCTION_MIGRATION_APPLY' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_GO_NO_GO_V1.csv
  grep -q 'GO_TO_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_STAGING_REHEARSAL_PLAN_V1' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_APPLY_READINESS_REVIEW_V1.md
  grep -q 'validate_treatment_framework_signed_review_state_persistence_migration_apply_readiness_review.py' scripts/ci_static_checks.sh

  printf '%s\n' "PASS: treatment framework signed review state persistence migration apply readiness review static markers"
...
printf '%s\n' "[smoke_petmed] staging rehearsal evidence compatibility check"
test -f "docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_STAGING_REHEARSAL_EVIDENCE_V1.md"
test -f "docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_STAGING_REHEARSAL_EVIDENCE_CHECKLIST_V1.csv"
test -f "docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_STAGING_REHEARSAL_SCHEMA_EVIDENCE_V1.csv"
test -f "docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_STAGING_REHEARSAL_SMOKE_EVIDENCE_V1.csv"
test -f "docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_STAGING_REHEARSAL_EVIDENCE_GO_NO_GO_V1.csv"
test -f "scripts/validate_treatment_framework_signed_review_state_persistence_migration_staging_rehearsal_evidence.py"
grep -q 'stage_id=PMAI-P0-01' "docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_STAGING_REHEARSAL_EVIDENCE_V1.md"
grep -q 'EVIDENCE_COMPLETENESS=PARTIAL' "docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_STAGING_REHEARSAL_EVIDENCE_V1.md"
grep -q 'ROLLBACK_RESTORE_EVIDENCE_COMPLETE=false' "docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_STAGING_REHEARSAL_EVIDENCE_V1.md"
grep -q 'decision=GO_TO_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_ROLLBACK_RESTORE_EVIDENCE_V1' "docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_STAGING_REHEARSAL_EVIDENCE_V1.md"
printf '%s\n' "PASS: staging rehearsal evidence compatibility markers"
...
# >>> treatment_framework_signed_review_state_persistence_migration_authenticated_staging_smoke_v1_smoke_petmed_compatibility_gate
PETMED_P0_04_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
printf '%s\n' "[smoke_petmed] PMAI-P0-03 completed package static compatibility"
test -f "${PETMED_P0_04_ROOT}/docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_AUTHENTICATED_STAGING_SMOKE_V1.md"
grep -q 'stage_id=PMAI-P0-03' "${PETMED_P0_04_ROOT}/docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_AUTHENTICATED_STAGING_SMOKE_V1.md"
grep -q 'STAGE_STATUS=COMPLETE' "${PETMED_P0_04_ROOT}/docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_AUTHENTICATED_STAGING_SMOKE_V1.md"
grep -q 'EVIDENCE_COMPLETENESS=COMPLETE' "${PETMED_P0_04_ROOT}/docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_AUTHENTICATED_STAGING_SMOKE_V1.md"
grep -q 'P0_04_ENTRY_AUTHORIZED=true' "${PETMED_P0_04_ROOT}/docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_AUTHENTICATED_STAGING_SMOKE_V1.md"
grep -q 'evidence_artifact_sha256=da52b46466a65316331d420c809bc406e49dfa722b1b5875667e30db50eef213' "${PETMED_P0_04_ROOT}/docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_AUTHENTICATED_STAGING_SMOKE_V1.md"
grep -q 'decision=GO_TO_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_0010_STAGING_MIGRATION_APPLY_V1' "${PETMED_P0_04_ROOT}/docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_AUTHENTICATED_STAGING_SMOKE_V1.md"
printf '%s\n' "PASS: PMAI-P0-03 static compatibility markers"
printf '%s\n' "treatment_framework_signed_review_state_persistence_migration_authenticated_staging_smoke_v1=COMPLETE"
# <<< treatment_framework_signed_review_state_persistence_migration_authenticated_staging_smoke_v1_smoke_petmed_compatibility_gate

# >>> treatment_framework_signed_review_state_persistence_migration_0010_staging_migration_apply_v1_smoke_petmed_runtime_gate
printf '%s\n' "[smoke_petmed] PMAI-P0-04 governance preparation package check"
python3 "${PETMED_P0_04_ROOT}/scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_staging_migration_apply.py"
printf '%s\n' "PASS: PMAI-P0-04 governance preparation markers"
...
printf '%s\n' "approved_audit_semantics_trigger_required=true"
...
printf '%s\n' "runner_executed_by_cumulative_smoke=false"
...
printf '%s\n' "current_decision=HOLD_PMAI_P0_04_PENDING_DISPOSABLE_TARGET_PROVISIONING_RESTORE_REHEARSAL_AND_EXTERNAL_EVIDENCE"
# <<< treatment_framework_signed_review_state_persistence_migration_0010_staging_migration_apply_v1_smoke_petmed_runtime_gate
