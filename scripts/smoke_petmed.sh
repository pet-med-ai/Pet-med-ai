...
printf '%s\n' "[smoke_petmed] treatment framework signed review state persistence migration rollback restore evidence package check"
python3 "${PETMED_ROLLBACK_RESTORE_EVIDENCE_ROOT}/scripts/validate_treatment_framework_signed_review_state_persistence_migration_rollback_restore_evidence.py"
printf '%s\n' "PASS: treatment framework signed review state persistence migration rollback restore evidence package markers"
printf '%s\n' "treatment_framework_signed_review_state_persistence_migration_rollback_restore_evidence_v1_package_v1=PASS"
printf '%s\n' "treatment_framework_signed_review_state_persistence_migration_rollback_restore_evidence_v1=IN_PROGRESS"
printf '%s\n' "stage_id=PMAI-P0-02"
...
printf '%s\n' "no_dose_route_frequency=true"
printf '%s\n' "not_client_facing=true"
printf '%s\n' "current_decision=HOLD_PMAI_P0_02_PENDING_EXTERNAL_ROLLBACK_RESTORE_EVIDENCE"
# <<< treatment_framework_signed_review_state_persistence_migration_rollback_restore_evidence_v1_smoke_petmed_runtime_gate
