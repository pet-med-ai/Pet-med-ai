...
printf '%s\n' "[smoke_petmed] PMAI-P0-03 authenticated staging smoke completed package check"
python3 "${PETMED_P0_03_ROOT}/scripts/validate_treatment_framework_signed_review_state_persistence_migration_authenticated_staging_smoke.py" --require-complete
printf '%s\n' "PASS: PMAI-P0-03 authenticated staging smoke completed package markers"
...
printf '%s\n' "current_decision=GO_TO_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_0010_STAGING_MIGRATION_APPLY_V1"
# <<< treatment_framework_signed_review_state_persistence_migration_authenticated_staging_smoke_v1_smoke_petmed_runtime_gate
