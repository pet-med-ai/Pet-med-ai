...
def main() -> int:
    print("Validating Case Detail Treatment Framework Signed Review State Persistence UI V1")
    ...
    doc = read("docs/clinical_data/CASE_DETAIL_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_UI_V1.md")
    checklist = read("docs/clinical_data/CASE_DETAIL_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_UI_CHECKLIST_V1.csv")
    go_no_go = read("docs/clinical_data/CASE_DETAIL_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_UI_GO_NO_GO_V1.csv")
    ...
    dry_run_doc = read("docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DRY_RUN_V1.md")
    ...
    require_tokens("CaseDetail UI", case_detail, [
        ...
        "buildTreatmentFrameworkSignedReviewStatePersistencePreview",
        "buildSignedReviewStatePersistencePayload",
    ...
    require_tokens("checklist", checklist, [
        "case_detail_signed_review_state_persistence_ui_only",
        "uses_persistence_prepare_dry_run_endpoint_only",
    ...
    require_tokens("go_no_go", go_no_go, [
        "signed_review_state_persistence_ui_static_smoke",
    ...
    require_tokens("ci", ci, [
        ...
        "case detail signed review state persistence UI markers",
    ...
    require(
        ...
        "smoke must call persistence UI static check after persistence dry-run smoke",
    )

    require("TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_DRY_RUN_MODE" in backend, "persistence dry-run backend mode missing")
    ...
    require("GO_TO_CASE_DETAIL_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_UI_V1" in dry_run_doc, "previous dry-run decision missing")
    ...
    print("PASS: Case Detail Treatment Framework Signed Review State Persistence UI V1")
    print("case_detail_treatment_framework_signed_review_state_persistence_ui=PASS_REQUIRED")
    ...
    print("decision=GO_TO_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_READINESS_REVIEW_V1")
    return 0
