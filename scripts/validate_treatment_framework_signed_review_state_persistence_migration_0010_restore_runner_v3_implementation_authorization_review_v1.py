...
def main() -> int:
    ...
    need(len(commands) == 26 and commands == EXPECTED_COMMANDS, "CI command contract")
    ...
    need(commands[-3:] == ["python3 " + VALIDATOR + " || exit 1", fresh_target_preparation_command, fresh_target_authorization_review_command], "CI command order")
