...
# --- Exotics Drug Dose Source Review Evidence Tables V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Evidence Tables V1 static checks"
python3 scripts/validate_exotics_drug_dose_source_review_evidence_tables.py
# --- Exotics Drug Dose Source Review Evidence Tables V1 static checks: end ---

# --- Exotics Drug Dose Source Review Source Registry V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Source Registry V1 static checks"
python3 scripts/validate_exotics_drug_dose_source_review_source_registry.py
# --- Exotics Drug Dose Source Review Source Registry V1 static checks: end ---

# --- Exotics Drug Dose Source Review Source Collection Protocol V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Source Collection Protocol V1 static checks"
python3 scripts/validate_exotics_drug_dose_source_review_source_collection_protocol.py
# --- Exotics Drug Dose Source Review Source Collection Protocol V1 static checks: end ---

# --- Exotics Drug Dose Source Review Source Collection Execution Readiness V1 static checks: start ---
...
# --- Exotics Drug Dose Source Review Source Collection Controlled Pilot Report V1 static checks: start ---
...
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace V1 static checks: start ---
...
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Validation Report V1 static checks: start ---
...
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record V1 validator"
python3 scripts/validate_exotics_drug_dose_source_review_metadata_only_collection_workspace_governance_signoff_record.py
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record V1 static checks: end ---

# --- Pet-Med-AI Future Development Outline V1 static checks: start ---
...
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record Validation Report V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record Validation Report V1"
...
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record Validation Report V1 static checks: end ---

# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record Final Go/No-Go V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record Final Go/No-Go V1 validator"
...
# --- Exotics Drug Dose Source Review Metadata-only Collection Workspace Governance Signoff Record Final Go/No-Go V1 static checks: end ---

# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness V1 validator"
python3 scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_readiness.py
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness V1 static checks: end ---

# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report V1"
python3 scripts/validate_exotics_drug_dose_source_review_metadata_only_source_collection_activation_readiness_report.py
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report V1 static checks: end ---

# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report Final Go/No-Go V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report Final Go/No-Go V1"
...
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Readiness Report Final Go/No-Go V1 static checks: end ---
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff V1 static checks"
...
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff V1 static checks: end ---

# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record V1"
...
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record V1 static checks: end ---

# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Validation V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Validation V1"
...
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Validation V1 static checks: end ---
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Validation Report V1 static checks: start ---
echo "[ci_static_checks] Exotics metadata-only source collection activation governance signoff record validation report V1 static checks"
...
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Validation Report V1 static checks: end ---

# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Final Go/No-Go V1 static checks: start ---
echo "[ci_static_checks] Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Final Go/No-Go V1 validator"
...
# --- Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Final Go/No-Go V1 static checks: end ---
