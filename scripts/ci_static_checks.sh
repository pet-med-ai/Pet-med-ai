...
# PMAI-P0-04 disposable target retirement execution evidence v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_disposable_target_retirement_execution_evidence_v1.py || exit 1

# PMAI-P0-04 fresh restore governance decision v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_fresh_restore_governance_decision_v1.py || exit 1

# PMAI-P0-04 archive root contract investigation preparation v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_archive_root_contract_investigation_preparation_v1.py || exit 1

# PMAI-P0-04 archive root contract investigation authorization review v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_archive_root_contract_investigation_authorization_review_v1.py || exit 1

# PMAI-P0-04 archive root contract investigation execution evidence v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_archive_root_contract_investigation_execution_evidence_v1.py || exit 1

# PMAI-P0-04 structural predicate review governance decision v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_structural_predicate_review_governance_decision_v1.py || exit 1

# PMAI-P0-04 archive root contract investigation V2 preparation v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_archive_root_contract_investigation_v2_preparation_v1.py || exit 1

# PMAI-P0-04 archive root contract investigation V2 authorization review v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_archive_root_contract_investigation_v2_authorization_review_v1.py || exit 1

# PMAI-P0-04 archive root contract investigation V2 execution evidence v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_archive_root_contract_investigation_v2_execution_evidence_v1.py || exit 1

# PMAI-P0-04 V2 post-execution structural review governance decision v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_archive_root_contract_investigation_v2_post_execution_structural_review_governance_decision_v1.py || exit 1

# PMAI-P0-04 archive root contract investigation V3 preparation v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_archive_root_contract_investigation_v3_preparation_v1.py || exit 1

# PMAI-P0-04 archive root contract investigation V3 authorization review v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_archive_root_contract_investigation_v3_authorization_review_v1.py || exit 1
