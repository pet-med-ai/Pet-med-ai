...
grep -q 'EVIDENCE_COMPLETENESS=PENDING_DISPOSABLE_RESTORE_REHEARSAL_AND_EXTERNAL_EXECUTION' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_0010_STAGING_MIGRATION_APPLY_V1.md
...
grep -q 'decision=HOLD_PMAI_P0_04_PENDING_DISPOSABLE_RESTORE_REHEARSAL_AND_EXTERNAL_EVIDENCE' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_0010_STAGING_MIGRATION_APPLY_V1.md
...
grep -q 'HOLD_PMAI_P0_04_PENDING_DISPOSABLE_RESTORE_REHEARSAL_AND_EXTERNAL_EVIDENCE' docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_0010_STAGING_MIGRATION_APPLY_GO_NO_GO_V1.csv
...
grep -q 'decision=HOLD_PMAI_P0_04_PENDING_DISPOSABLE_RESTORE_REHEARSAL_AND_EXTERNAL_EVIDENCE' scripts/smoke_petmed.sh
