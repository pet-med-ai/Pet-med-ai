...
# PMAI-P0-04 archive root contract investigation V3 execution evidence v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_archive_root_contract_investigation_v3_execution_evidence_v1.py || exit 1

# PMAI-P0-04 restore runner design preparation V3
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_restore_runner_design_preparation_v3.py || exit 1

# PMAI-P0-04 restore runner V3 authorization review v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_restore_runner_v3_authorization_review_v1.py || exit 1

# PMAI-P0-04 restore runner V3 implementation preparation v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_restore_runner_v3_implementation_preparation_v1.py || exit 1

# PMAI-P0-04 restore runner V3 implementation authorization review v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_restore_runner_v3_implementation_authorization_review_v1.py || exit 1

# PMAI-P0-04 fresh disposable target provisioning authorization preparation v3
...
# PMAI-P0-04 fresh disposable target provisioning authorization review v3
...
# PMAI-P0-04 fresh disposable target provisioning external execution authorization v3
...
# PMAI-P0-04 fresh disposable target provisioning execution evidence v3
...
# PMAI-P0-04 active restore runner V3 creation and activation preparation v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_active_restore_runner_v3_creation_and_activation_preparation_v1.py || exit 1

# PMAI-P0-04 active restore runner V3 creation and activation authorization review v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_active_restore_runner_v3_creation_and_activation_authorization_review_v1.py || exit 1

# PMAI-P0-04 active restore runner V3 creation and activation execution authorization v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_active_restore_runner_v3_creation_and_activation_execution_authorization_v1.py || exit 1

# PMAI-P0-04 active restore runner V3 sanitized runtime binding evidence collection and review preparation v1
python3 scripts/validate_treatment_framework_signed_review_state_persistence_migration_0010_active_restore_runner_v3_sanitized_runtime_binding_evidence_collection_and_review_preparation_v1.py --dry-run || exit 1
