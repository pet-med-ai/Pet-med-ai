...
EXPECTED_CI_TARGETS_SHA256 = "c110b0f3ff5a9eb58845982bd6796df7cca25277b11d56f3241c06666ab8bb6a"
EXPECTED_CI_COMMANDS_SHA256 = "0fe4873894563f6d4e409bfe2885c410de51bc9c15f41aae85f8d1e7e55f783e"
...
def main() -> int:
    ...
    need(len(targets) == 127 and len(set(targets)) == 127, "CI target cardinality")
    ...
    need(len(commands) == 26, "CI command cardinality")
