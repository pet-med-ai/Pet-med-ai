...
def main() -> int:
    print("Validating Case Detail Treatment Framework Signed Review State Persistence Migration UI V1")
    ...
    doc = read("docs/clinical_data/CASE_DETAIL_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_UI_V1.md")
    checklist = read("docs/clinical_data/CASE_DETAIL_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_UI_CHECKLIST_V1.csv")
    go_no_go = read("docs/clinical_data/CASE_DETAIL_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_UI_GO_NO_GO_V1.csv")
    ...
    dry_run_doc = read("docs/clinical_data/TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DRY_RUN_V1.md")
    ...
    require_tokens("CaseDetail UI", case_detail, [
        ...
        "buildTreatmentFrameworkSignedReviewStateMigrationPreview",
        "buildSignedReviewStateMigrationPayload",
    ...
    require_tokens("checklist", checklist, [
        "case_detail_signed_review_state_persistence_migration_ui_only",
        "uses_migration_dry_run_endpoint_only",
        "migration_disabled",
        "schema_change_disabled",
        "no_case_treatment_write",
        "no_prescription_write",
        "no_dose_route_frequency",
    ])
    require_tokens("go_no_go", go_no_go, [
        "migration_ui_static_smoke",
        "migration_write",
        "schema_change",
    ...
    require_tokens("ci", ci, [
        ...
        "case detail signed review state persistence migration UI markers",
    ...
    require(
        ...
        "smoke must call migration UI static check after migration dry-run smoke",
    )

    require("TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_DRY_RUN_MODE" in backend, "migration dry-run backend mode missing")
    ...
    require("GO_TO_CASE_DETAIL_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_UI_V1" in dry_run_doc, "previous migration dry-run decision missing")
    ...
    print("PASS: Case Detail Treatment Framework Signed Review State Persistence Migration UI V1")
    print("case_detail_treatment_framework_signed_review_state_persistence_migration_ui=PASS_REQUIRED")
    ...
    print("decision=GO_TO_TREATMENT_FRAMEWORK_SIGNED_REVIEW_STATE_PERSISTENCE_MIGRATION_FINAL_GO_NO_GO_V1")
    return 0
