...
def main() -> int:
    ...
    need(
        ...
        and python_lines(ci)[-6:] == [command, authorization_review_command, implementation_preparation_command, implementation_authorization_review_command, fresh_target_preparation_command, fresh_target_authorization_review_command],
        "CI command order",
    )
