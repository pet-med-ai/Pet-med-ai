...
export default function CaseDetail() {
  ...
  return (
    <div style={{ padding:24, maxWidth:960, margin:"0 auto", fontFamily:"system-ui,-apple-system,Arial" }}>
      <h1 style={{ marginTop:0 }}>病例 #{data.id}</h1>
      ...
      <div style={{ display:"flex", gap:8, marginTop:16 }}>
        ...
        <button onClick={doDelete} disabled={deleting} style={btnDanger}>{deleting ? "删除中…" : "删除"}</button>
...
const row = { display:"grid", gridTemplateColumns:"120px 1fr", gap:12, padding:"8px 0", borderBottom:"1px solid #eee" };
const btn = { padding:"8px 14px", borderRadius:8, border:"1px solid #64748b", background:"#fff", color:"#111", textDecoration:"none", display:"inline-block" };
