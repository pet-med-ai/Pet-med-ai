...
EXOTICS_DRUG_DOSE_SOURCE_REVIEW_METADATA_ONLY_COLLECTION_WORKSPACE_GOVERNANCE_SIGNOFF_RECORD_MODE = "exotics_drug_dose_source_review_metadata_only_collection_workspace_governance_signoff_record_v1"
...
FORBIDDEN_COLUMNS = ['numeric_dose_value', 'dose_unit', 'route_text', 'frequency_text', 'duration_text', 'prescription_direction', 'treatment_protocol', 'client_instruction', 'copied_table_text', 'copyrighted_full_text']

ALLOWED_METADATA_ONLY_FIELDS = ['governance_signoff_record_id', 'species_group', 'review_domain', 'governance_signoff_id', 'workspace_scope', 'clinical_owner_record_status', 'second_reviewer_record_status', 'source_access_record_status', 'copyright_access_record_status', 'metadata_only_policy_record_status', 'value_capture_blocker_record_status', 'collection_execution_status', 'signoff_record_status', 'signoff_completed_status', 'go_no_go_status', 'human_review_required', 'clinician_signoff_required', 'next_required_stage']
...
def build_governance_signoff_record_matrix() -> List[Dict[str, str]]:
    rows: List[Dict[str, str]] = []
    for species_group in SPECIES_GROUPS:
        for review_domain in REVIEW_DOMAINS:
            rows.append({
                "governance_signoff_record_id": "gov-signoff-record-%s-%s" % (species_group, review_domain),
                ...
                "clinical_owner_record_status": "required_not_recorded",
                "second_reviewer_record_status": "required_not_recorded",
                "source_access_record_status": "required_not_recorded",
                "copyright_access_record_status": "required_not_recorded",
                "metadata_only_policy_record_status": "defined_not_signed",
                "value_capture_blocker_record_status": "required_enabled_not_signed",
                "collection_execution_status": "not_started_not_allowed",
                "signoff_record_status": "schema_defined_no_signed_record",
                "signoff_completed_status": "not_completed",
                "go_no_go_status": "NO_GO_TO_COLLECTION_EXECUTION",
                "human_review_required": "true",
                "clinician_signoff_required": "true",
                "next_required_stage": "EXOTICS_DRUG_DOSE_SOURCE_REVIEW_METADATA_ONLY_COLLECTION_WORKSPACE_GOVERNANCE_SIGNOFF_RECORD_VALIDATION_V1",
            })
    return rows


def summarize_governance_signoff_record() -> Dict[str, Any]:
    rows = build_governance_signoff_record_matrix()
    flags = safety_flags()
    return {
        "mode": EXOTICS_DRUG_DOSE_SOURCE_REVIEW_METADATA_ONLY_COLLECTION_WORKSPACE_GOVERNANCE_SIGNOFF_RECORD_MODE,
