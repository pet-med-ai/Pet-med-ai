...
EXOTICS_DRUG_DOSE_SOURCE_REVIEW_METADATA_ONLY_SOURCE_COLLECTION_ACTIVATION_READINESS_REPORT_MODE = "exotics_drug_dose_source_review_metadata_only_source_collection_activation_readiness_report_v1"
...
ALLOWED_REPORT_FIELDS = [
    "activation_readiness_report_id",
    "species_group",
    "review_domain",
    "activation_readiness_scope",
    "readiness_report_status",
    "activation_readiness_status",
    "final_go_no_go_status",
    "governance_signoff_record_final_go_no_go_status",
...
def activation_readiness_report_safety_flags() -> Dict[str, Any]:
    return {
        "read_only": True,
        "dry_run": True,
...
def build_activation_readiness_report_matrix() -> List[Dict[str, Any]]:
    rows: List[Dict[str, Any]] = []
    for species_group in SPECIES_GROUPS:
        for review_domain in REVIEW_DOMAINS:
            rows.append({
                "activation_readiness_report_id": "activation-readiness-report:%s:%s" % (species_group, review_domain),
                "species_group": species_group,
                "review_domain": review_domain,
                "activation_readiness_scope": "metadata_only_source_collection_activation_readiness_report",
                "readiness_report_status": "shell_defined_no_collection_results",
                "activation_readiness_status": "defined_not_passed",
                "final_go_no_go_status": "no_go_to_activation",
                "governance_signoff_record_final_go_no_go_status": "no_go_to_collection_execution",
                ...
                "activation_scope_status": "metadata_only_scope_defined",
                ...
                "report_status": "readiness_report_shell_only",
                "go_no_go_status": "NO_GO_TO_METADATA_ONLY_SOURCE_COLLECTION_ACTIVATION",
                "human_review_required": True,
                "clinician_signoff_required": True,
                "next_required_stage": "EXOTICS_DRUG_DOSE_SOURCE_REVIEW_METADATA_ONLY_SOURCE_COLLECTION_ACTIVATION_READINESS_REPORT_FINAL_GO_NO_GO_V1",
            })
    return rows


def build_activation_readiness_report() -> Dict[str, Any]:
    matrix = build_activation_readiness_report_matrix()
    safety = activation_readiness_report_safety_flags()
    return {
        "mode": EXOTICS_DRUG_DOSE_SOURCE_REVIEW_METADATA_ONLY_SOURCE_COLLECTION_ACTIVATION_READINESS_REPORT_MODE,
        ...
        "allowed_report_fields": list(ALLOWED_REPORT_FIELDS),
