...
STAGE = "Exotics Drug Dose Source Review Metadata-only Source Collection Activation Governance Signoff Record Validation Report V1"
...
NEXT_STAGE = "GO_TO_EXOTICS_DRUG_DOSE_SOURCE_REVIEW_METADATA_ONLY_SOURCE_COLLECTION_ACTIVATION_GOVERNANCE_SIGNOFF_RECORD_FINAL_GO_NO_GO_V1"
...
ALLOWED_METADATA_FIELDS: List[str] = [
    ...
    "clinical_owner_record_check_status",
    "second_reviewer_record_check_status",
    "source_access_record_check_status",
    "copyright_access_record_check_status",
    "metadata_only_policy_record_check_status",
    "value_capture_blocker_record_check_status",
    "activation_scope_record_check_status",
    "halt_rule_record_check_status",
    ...
    "validation_report_has_collection_results",
    "go_no_go_status",
    "governance_decision",
...
def build_report_row(species_group: str, review_domain: str) -> Dict[str, str]:
    return {
        "validation_report_id": "activation-governance-signoff-record-validation-report:%s:%s" % (species_group, review_domain),
        ...
        "validation_report_scope": "activation_governance_signoff_record_validation_report_shell_only",
        "validation_report_status": "schema_defined_no_collection_results",
        "clinical_owner_record_check_status": "reported_required_not_verified",
        "second_reviewer_record_check_status": "reported_required_not_verified",
        "source_access_record_check_status": "reported_required_not_verified",
        "copyright_access_record_check_status": "reported_required_not_verified",
        "metadata_only_policy_record_check_status": "reported_required_not_verified",
        "value_capture_blocker_record_check_status": "reported_required_not_verified",
        "activation_scope_record_check_status": "reported_required_not_verified",
        "halt_rule_record_check_status": "reported_required_not_verified",
        ...
        "validation_report_has_collection_results": "false",
...
def build_matrix() -> List[Dict[str, str]]:
    ...
    for species_group in SPECIES_GROUPS:
        for review_domain in REVIEW_DOMAINS:
            rows.append(build_report_row(species_group, review_domain))
    return rows
