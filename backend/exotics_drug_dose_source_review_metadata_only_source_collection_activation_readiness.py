...
MODE = "exotics_drug_dose_source_review_metadata_only_source_collection_activation_readiness_v1"
...
NEXT_DECISION = "GO_TO_EXOTICS_DRUG_DOSE_SOURCE_REVIEW_METADATA_ONLY_SOURCE_COLLECTION_ACTIVATION_READINESS_REPORT_V1"
...
def build_activation_readiness_matrix() -> List[Dict[str, Any]]:
    rows: List[Dict[str, Any]] = []
    for species_group in SPECIES_GROUPS:
        for review_domain in REVIEW_DOMAINS:
            rows.append({
                "activation_readiness_id": "activation-readiness-%s-%s" % (species_group, review_domain),
                "species_group": species_group,
                "review_domain": review_domain,
                "final_go_no_go_status": "defined_no_collection_execution",
                ...
                "source_access_activation_status": "required_not_completed",
                "copyright_access_activation_status": "required_not_completed",
                "metadata_only_workspace_status": "defined_not_populated",
                "metadata_only_validation_status": "defined_not_executed",
                "forbidden_value_scanner_status": "required_not_validated",
                "activation_scope_status": "defined_as_metadata_only",
                "pilot_sample_limit_status": "required_not_started",
                "halt_rule_status": "required_not_started",
                "collection_activation_allowed_now": False,
                "collection_execution_started": False,
                "collection_execution_allowed_now": False,
                "pilot_execution_allowed_now": False,
...
def build_activation_readiness_summary() -> Dict[str, Any]:
    matrix = build_activation_readiness_matrix()
    safety = safety_flags()
    return {
        "mode": MODE,
